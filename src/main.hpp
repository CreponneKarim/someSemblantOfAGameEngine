...
inline glm::vec3 	lightColor(1.0f);
inline glm::vec3	ambient{0.07f * lightColor};
inline glm::vec3	diffuse{0.1f * lightColor};	
inline char glslVersion[]="#version 330 core";

inline bool renderingMode{true};
